...
Revision ID: fdb491e64d62
Revises: 1e4beb252612
Create Date: 2020-12-12 20:30:53.978189
...
revision = 'fdb491e64d62'
down_revision = '1e4beb252612'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('seekMessage', sa.Text(), nullable=True),
    ...
    op.drop_table('Venue')
    op.add_column('artist', sa.Column('seekMessage', sa.Text(), nullable=True))
